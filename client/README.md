...
* `create-react-app` is a command-line utility that you use to create new projects. `npx` is used to run this.
...
The service worker will use a [cache-first ](https://developers.google.com/web/fundamentals/instant-and-offline/offline-cookbook/#cache-falling-back-to-network)
...
runtime caching  for those requests, you can [`eject`](#npm-run-eject)
